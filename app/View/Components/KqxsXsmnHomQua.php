...
class KqxsXsmnHomQua extends BaseEmbed
{
    protected function getKey(): string
    {
        return 'kqxs-xsmn-hom-qua';
    }
    ...
    protected function logicGetData(): array
    {
        ...
        $crawler = $this->crawler("https://atrungroi.com/xsmn-$jn-ket-qua-xo-so-mien-nam-ngay-$jnY.html");
        ...
        $html = str_replace('table align-middle kq-table Sunday xsmn js-kq-table', 'table-kqxs table-kqxs-multi text-center fw-7', $html);
